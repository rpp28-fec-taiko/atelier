...
describe ('Image Thumbnail', () => {
  ...
  it('checks that image thumbnail is given the correct classname if it matches the currently displayed image', () => {
  ...
  it('checks that image thumbnail is given correct classname if it does not match the currently displayed image', () => {
